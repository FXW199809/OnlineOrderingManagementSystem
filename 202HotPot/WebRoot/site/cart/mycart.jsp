...
<div id="wrapper">
				...
				<div class="entry">
                    <table width="98%" border="0" cellpadding="2" cellspacing="1" align="center" style="margin-top:8px">
											...
											<tr align='center' bgcolor="#FFFFFF" height="22">
												...
												<td bgcolor="#FFFFFF" align="center">￥:${item.value.goods.price}</td>
												...
												<!-- 改变数量 -->
												<td bgcolor="#FFFFFF" align="center">${item.value.goods.price * item.value.goods_quantity}</td>
												<!-- 总金额=特价*数量 -->
	...
	<div id="footer">
		<p><a href="<%=path %>/login.jsp">点击进入202火锅店后台</a></p>
	</div>
	</div>
</div>
</body>
