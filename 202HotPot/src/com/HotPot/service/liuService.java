...
import com.HotPot.orm.Tcatelog;
...
public class liuService
{
	...
	//保存订单
	{
		String sql="insert into t_order(id,bianhao,shijian,zhuangtai,jine,user_id) values(?,?,?,?,?,?)";
		Object[] params={order.getId(),order.getBianhao(),order.getShijian(),order.getZhuangtai(),order.getJine(),order.getUser_id()};
		DB mydb=new DB();
		mydb.doPstm(sql, params);
		mydb.closed();
	}
